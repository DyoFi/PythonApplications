...
class TDApp(App):
    ...
    def show_dashboard(self):
        ...
        self.root_layout.add_widget(date_label)
        ...
        add_btn.bind(on_release=lambda x: self.show_add_task())
    ...
    def show_add_task(self):
        ...
        self.root_layout.add_widget(obj_input)
        ...
        self.root_layout.add_widget(deadline_input)
        ...
        self.root_layout.add_widget(priority_spinner)
        ...
        save_btn = Button(
            ...
            on_press = lambda x: save_task(x)
        )
        
        self.root_layout.add_widget(save_btn)

        back_btn = Button(
            text="Back",
            size_hint=(0.38, 0.1),
            pos_hint={'x': 0.02, 'y': 0.05},
            on_press = lambda x: self.show_dashboard() 
        )
